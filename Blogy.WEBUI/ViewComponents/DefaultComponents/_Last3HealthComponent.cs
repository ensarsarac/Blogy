...
{
	public class _Last3HealthComponent:ViewComponent
	{
		private readonly IArticleService _articleService;

		public _Last3HealthComponent(IArticleService articleService)
		{
			_articleService = articleService;
		}
		public IViewComponentResult Invoke()
		{
			var values = _articleService.TCategoryHealthLast3Article();
