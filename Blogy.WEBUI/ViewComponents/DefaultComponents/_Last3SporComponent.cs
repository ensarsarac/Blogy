...
{
    public class _Last3SporComponent:ViewComponent
    {
        private readonly IArticleService _articleService;

        public _Last3SporComponent(IArticleService articleService)
        {
        ...
        {
            var values = _articleService.TCategorySporLast3Article();
